...
{
    public class UpdateAssignmentDTO : IValidatableObject
    {
        [Required]
        ...
        [Required]
        [RegularExpression("(?i)^(SCHEDULED|IN_PROGRESS|COMPLETED|MISSED|CANCELLED)$", ErrorMessage = "Status must be one of: SCHEDULED, IN_PROGRESS, COMPLETED, MISSED, CANCELLED.")]
